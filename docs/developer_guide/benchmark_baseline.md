...
## SoulX-LiveAct Ascend 195 基线

2026-04-28 在内部 Ascend 910B2 主机完成 `soulx-liveact-14b` script-backed wrapper 真机验证。测试口径：
...
- 产物目录：`benchmarks/liveact-ascend195-omnirt-20260428_192225`
