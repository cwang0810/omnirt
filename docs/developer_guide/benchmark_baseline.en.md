...
## SoulX-LiveAct Ascend 195 Baseline

On 2026-04-28, the `soulx-liveact-14b` script-backed wrapper completed a real-hardware run on an internal Ascend 910B2 host. Test scope:
...
- Artifact directory: `benchmarks/liveact-ascend195-omnirt-20260428_192225`
